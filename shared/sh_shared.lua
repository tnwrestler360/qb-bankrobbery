...
Shared.MinigameSettings = {
    laptop = {
        ['fleeca'] = { time = 15, blocks = 2, amount = 1 }, --blocks=3 amount = 3
        ['maze'] = { time = 11, blocks = 4, amount = 4 },
        ['paleto'] = { time = 12, blocks = 2, amount = 1 }, --blocks=5 amount = 4
...
Shared.BankSettings = {
    ...
    PaletoInputTime = 3000, -- Time in milliseconds where all 3 inputs must be entered
    PacificInputTime = 3000 -- Time in milliseconds where both inputs must be entered
}
...
Shared.Banks = { -- This is mainly for storing variables that are used and/or change dynamically during the script
    ['PinkCage'] = {
        ...
        size = 15,
        keycardTaken = false,
        door = { id = 'bankrobbery-pinkcage_door2', coords = vector3(308.69, -281.55, 54.33) },
    ...
    ['Legion'] = {
        ...
        size = 15,
        keycardTaken = false,
        door = { id = 'bankrobbery-legion_door2', coords = vector3(144.36, -1043.19, 29.53) },
    ...
    ['Hawick'] = {
        ...
        size = 15,
        keycardTaken = false,
        door = { id = 'bankrobbery-hawick_door2', coords = vector3(-356.42, -52.46, 49.20) }, 
    ...
    ['DelPerro'] = {
        ...
        size = 15,
        keycardTaken = false,
        door = { id = 'bankrobbery-delperro_door2', coords = vector3(-1214.62, -336.44, 37.94) },
    ...
    ['GreatOcean'] = {
        ...
        size = 15,
        keycardTaken = false,
        door = { id = 'bankrobbery-greatocean_door2', coords = vector3(-2958.54, 478.42, 15.86) },
    ...
    ['Sandy'] = {
        ...
        size = 15,
        keycardTaken = false,
        door = { id = 'bankrobbery-sandy_door2', coords = vector3(1179.39, 2711.02, 38.25) },
    ...
    ['Pacific'] = {
        ...
        searchDrawers = {
            [1] = { coords = vector4(257.23, 204.99, 109.17, 70.0), usb = false },
            [2] = { coords = vector4(254.91, 207.69, 109.17, 250.0), usb = false },
            [3] = { coords = vector4(264.27, 233.28, 109.17, 250.0), usb = false },
            [4] = { coords = vector4(267.79, 234.14, 109.17, 70.0), usb = false },
            [5] = { coords = vector4(278.59, 209.42, 109.17, 160.0), usb = false },
            [6] = { coords = vector4(279.36, 206.79, 105.28, 250.0), usb = false },
            [7] = { coords = vector4(267.93, 209.16, 105.28, 160.0), usb = false },
            [8] = { coords = vector4(259.12, 212.27, 105.28, 160.0), usb = false },
            [9] = { coords = vector4(257.18, 204.98, 105.28, 70.0), usb = false },
            [10] = { coords = vector4(254.38, 206.24, 105.28, 250.0), usb = false },
            [11] = { coords = vector4(264.48, 227.54, 105.28, 160.0), usb = false },
            [12] = { coords = vector4(264.98, 235.36, 105.28, 250.0), usb = false },
            [13] = { coords = vector4(267.85, 234.04, 105.28, 70.0), usb = false },
            [14] = { coords = vector4(273.98, 223.91, 105.28, 160.0), usb = false },
            [15] = { coords = vector4(277.05, 220.43, 105.28, 160.0), usb = false },
            [16] = { coords = vector4(273.04, 209.52, 105.28, 160.0), usb = false },
        },
        sideVaults = {
            [1] = { id = 'bankrobbery-vault-door6', laptop = vector4(242.35, 218.52, 97.0, 160.0), hacked = false },
            [2] = { id = 'bankrobbery-vault-door7', laptop = vector4(247.47, 233.38, 97.0, 340.0), hacked = false }
        },
        thermite = {
            [1] = { coords = vector4(272.75, 215.98, 110.25, 250.0), ptfx = vector3(272.70, 217.0, 110.25), doorId = 'bankrobbery-pacific-office-main', hit = false },
            [2] = { coords = vector4(252.15, 217.33, 97.22, 70.0), ptfx = vector3(252.15, 218.33, 97.22), doorId = 'bankrobbery-vault-door3', hit = false },
            [3] = { coords = vector4(256.10, 228.26, 97.22, 70.0), ptfx = vector3(256.07, 229.26, 97.22), doorId = 'bankrobbery-vault-door4', hit = false },
            [4] = { coords = vector4(265.36, 224.86, 97.22, 250.0), ptfx = vector3(265.30, 225.86, 97.22), doorId = 'bankrobbery-vault-door5', hit = false },
        },
        lockers = {
